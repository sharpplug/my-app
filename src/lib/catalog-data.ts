...
export const mockServiceItems: MarketplaceItem[] = [
  ...
  { category: 'electronics', title: "Wireless Earbuds Pro", description: "Noise-cancelling, 30hr battery", image: "https://picsum.photos/seed/earbuds/400/400", hint: "wireless earbuds", providerName: "TechBazaar", type: 'product', price: 340 },
  { category: 'electronics', title: "Smart Home Hub", description: "Voice control, works with all devices", image: "https://picsum.photos/seed/smarthub/400/400", hint: "smart home hub", providerName: "CircuitSouk", type: 'product', price: 520 },
  { category: 'farm', title: "Fresh Free-Range Eggs (30pk)", description: "Delivered from Karen farms", image: "https://picsum.photos/seed/eggs/400/400", hint: "free range eggs", providerName: "Green Souk", type: 'product', price: 45 },
  { category: 'farm', title: "Irrigation Drip Kit", description: "Covers up to 200 sqm", image: "https://picsum.photos/seed/irrigation/400/400", hint: "drip irrigation kit", providerName: "Harvest Supply Co.", type: 'product', price: 275 },
  { category: 'automotive', title: "All-Season Floor Mats", description: "Universal fit, 4-piece set", image: "https://picsum.photos/seed/floormats/400/400", hint: "car floor mats", providerName: "Desert Auto Parts", type: 'product', price: 160 },
  { category: 'automotive', title: "Dash Cam - 4K", description: "Front & rear recording", image: "https://picsum.photos/seed/dashcam/400/400", hint: "car dash cam", providerName: "Desert Auto Parts", type: 'product', price: 410 },
  { category: 'sports', title: "Yoga Mat + Block Set", description: "Non-slip, eco-friendly", image: "https://picsum.photos/seed/yogamat/400/400", hint: "yoga mat", providerName: "Flow Fitness", type: 'product', price: 95 },
  { category: 'sports', title: "Adjustable Dumbbell Pair", description: "5-25kg per side", image: "https://picsum.photos/seed/dumbbell/400/400", hint: "adjustable dumbbells", providerName: "Iron Souk", type: 'product', price: 780 },
  { category: 'kids', title: "Wooden Building Blocks", description: "100-piece set, ages 3+", image: "https://picsum.photos/seed/blocks/400/400", hint: "wooden building blocks", providerName: "Little Explorers", type: 'product', price: 130 },
  { category: 'books', title: "Arabic-English Storybook Set", description: "Bilingual, ages 5-9", image: "https://picsum.photos/seed/storybooks/400/400", hint: "childrens storybooks", providerName: "Souk Reads", type: 'product', price: 90 },
  { category: 'pets', title: "Cat Tower with Scratch Posts", description: "5-tier, includes hideaway", image: "https://picsum.photos/seed/cattower/400/400", hint: "cat tower", providerName: "Paws & Claws", type: 'product', price: 340 },
];
